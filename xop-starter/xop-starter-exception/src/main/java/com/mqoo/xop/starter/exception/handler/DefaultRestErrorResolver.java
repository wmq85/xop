...
public class DefaultRestErrorResolver
    ...
    protected final RestError createMappingExceptionTemplate(Exception e, RestError restError) {
        ...
        if (e instanceof BindException) {
            ...
            for (FieldError err : errors) {
                ...
                log.debug("binding validate field:{}, rejectedValue:{}, defaultMessage:{}", filed,
    ...
    protected final Map<String, String> createDefaultExceptionMappingDefinitions() {
        ...
        applyDef(m, org.springframework.web.servlet.NoHandlerFoundException.class,
     ...
     * or {@code null} if a match was not found.
     * <p/>
    ...
    private RestError getRestErrorTemplate(Exception ex) {
        ...
        ExceptionResponseInfo expInfo = AnnotatedElementUtils.findMergedAnnotation(ex.getClass(),
                ExceptionResponseInfo.class);
        ...
        if (null != template && log.isDebugEnabled()) {
            log.debug("Resolving to RestError template '{}' for exception of type [{}]", template,
                    ex.getClass().getName());
        }
    ...
    /**
     * Get http status value from exception first, if the message is blank, get it from annotation.
     *
    ...
    /**
     * Get error message from exception first, if the message is blank, get it from annotation.
     *
     * @param ex the exception
     * @param info the annotation instance
    ...
    /**
     * Get developer message from exception first, if the message is blank, get it from annotation.
     *
     * @param ex the exception
     * @param info the annotation instance
    ...
    /**
     * Get error code from exception first, if the code is blank, get it from annotation.
     *
     * @param ex the exception
     * @param info the annotation instance
     * @return error code
     ...
     * <code>null</code>, otherwise if more info is blank, get it from annotation.
     *
     * @param ex the exception
     * @param info the annotation instance
