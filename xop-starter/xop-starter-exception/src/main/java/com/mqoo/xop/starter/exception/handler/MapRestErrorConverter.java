...
/**
 * Simple {@code RestErrorConverter} implementation that creates a new Map instance based on the
 * specified RestError instance. Some {@link org.springframework.http.converter.HttpMessageConverter
 * HttpMessageConverter}s (like a JSON converter) can easily automatically convert Maps to response
 * bodies. The map is populated with the following default name/value pairs:
 *
 * <table>
 * <tr>
 * <th>Key (a String)</th>
