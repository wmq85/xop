...
/**
 * A {@code RestErrorResolver} resolves an exception and produces a {@link RestError} instance that
...
public interface RestErrorResolver {
     ...
     * exception.
     *
     * @param request current {@link ServletWebRequest} that can be used to obtain the source
     ...
     * @return a resolved {@code RestError} instance to render as the response body or
