package com.mqoo.platform.xop.support.security.filter;
...
import com.mqoo.platform.xop.support.security.validator.SecurityValidatorHandler;
...
public class SecurityFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		SecurityValidateContext securityValidateContext=new SecurityValidateContext(bufferedRequest);
		SecurityValidatorHandler securityValidatorHandler=SpringContextUtil.getBean(SecurityValidatorHandler.class);
	...
	public static void main(String[] args) {
		...
		String publicKey = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAKM8nJloFcufqoeUGYsMin4boFAxxaU4R6mJa6Bdr27vCsd2tmHL6PLcTyX/rnSbRIzHElK7xlGlSkXPIYRlsZsCAwEAAQ==";
