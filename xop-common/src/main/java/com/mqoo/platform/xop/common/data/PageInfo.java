...
public class PageInfo<T> implements Serializable {
     ...
     *
     * @param list          结果集
     * @param navigatePages 可浏览页码数量
     * @param total         总记录数
     * @param pageNum       页码
     * @param pageSize      每页记录数
     */
    public PageInfo(List<T> list, int navigatePages,long total,int pageNum,int pageSize) {
        ...
        //计算总页数
        this.pages = Double.valueOf(Math.ceil((double)total/(double)pageSize)).intValue();
